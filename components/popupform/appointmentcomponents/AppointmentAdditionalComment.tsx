...
export default function AppointmentAdditionalComment({
  onCommentsChange,
  onMediaIdsChange,
  onIsUploading,
}: Props) {
    ...
    <div className="flex-1 px-4">
      ...
      <div className="relative mb-4">
        <textarea
          ...
          className="w-full min-h-[150px] resize-none border border-gray-300 rounded-lg text-base p-3 placeholder:text-gray-400 focus:border-blue-500 focus:ring-blue-500 focus:outline-none"
          maxLength={maxLength}
        />
      ...
      <div className="flex flex-col items-center justify-center">
        <div className="relative">
          ...
          <div
            className="absolute -top-1 -right-1 w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center z-20 cursor-pointer hover:bg-green-600"
