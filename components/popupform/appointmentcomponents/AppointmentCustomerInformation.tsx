...
export default function AppointmentCustomerInformation({
  customerInfo,
      ...
      <div className="space-y-5">
        <div className="space-y-2">
          ...
          <input
            ...
            className={`w-full h-12 px-3 rounded-md focus:ring-0 focus:outline-none transition-colors duration-200 ${
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              onBlur={() => setFocusedField(null)}
              className={`w-full h-12 pl-10 rounded-md focus:ring-0 focus:outline-none transition-colors duration-200 ${
                focusedField === "phone"
                  ? "border-blue-500 border-2"
                  : "border border-gray-200"
              }`}
